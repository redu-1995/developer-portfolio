          ...
          <div className="bg-[#1E293B]/40 border border-[#1E293B] rounded-2xl p-6 space-y-5 shadow-xl shadow-black/10">
            ...
            <div className="group flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:rediet@example.com" className="text-[#F8FAFC] group-hover:text-[#38BDF8] transition-colors duration-200 font-medium text-sm">
                  rediet@example.com
                </a>
              </div>
            </div>
            ...
            <div className="group flex items-start gap-4">
              ...
              <div>
                ...
                <a href="https://linkedin.com/in/rediet" target="_blank" rel="noreferrer" className="text-[#F8FAFC] group-hover:text-[#38BDF8] transition-colors duration-200 font-medium text-sm">
                  linkedin.com/in/rediet
                </a>
              </div>
            </div>
            ...
            <div className="group flex items-start gap-4">
              ...
              <div>
                ...
                <a href="https://github.com/rediet" target="_blank" rel="noreferrer" className="text-[#F8FAFC] group-hover:text-[#38BDF8] transition-colors duration-200 font-medium text-sm">
                  github.com/rediet
                </a>
              </div>
            </div>
